    ...
    if method == "sq_split":
        grasp_poses_world = predict_grasp_pose_sq(gripper_pose_current, \
            ...
            if method == "cg":
                ...
                pc_full_depth = pc_full_depth@camera_extrinsics[:3, :3].T + camera_extrinsics[0:3, 3]
